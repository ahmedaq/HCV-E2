...
function [out_seq_ex hasNewAA listOfSitesWithNewAA] = convertAAseq2Bin_new(mutant_order,bin_matrix,input_parm)

% Code for converting an amino acid sequence into a binary extended matrix
% 
